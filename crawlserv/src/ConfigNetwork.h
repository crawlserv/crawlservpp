...
#ifndef SRC_CONFIGNETWORK_H_
#define SRC_CONFIGNETWORK_H_
...
public:
	...
	void setEntry(const std::string& name, const rapidjson::Value::ConstMemberIterator& iterator, std::vector<std::string>& warningsTo);
};

#endif /* SRC_CONFIGNETWORK_H_ */
