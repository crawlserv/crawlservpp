...
if(isset($website)) {
    ...
    $result = $dbConnection->query("SELECT id, name FROM crawlserv_configs WHERE website=$website AND module='parser'");
...
if(isset($website)) {
    ...
    else echo "<a href=\"#\" class=\"action-link config-add\" data-module=\"parser\" data-m=\"$m\">Add parser</a>\n";
    echo "</div>\n";
    echo "</div>\n";
    echo "</div>\n";
}
