...
if(isset($website)) {
    ...
    $result = $dbConnection->query(
            "SELECT id, name FROM crawlserv_configs WHERE website=$website AND module='parser' ORDER BY name"
    );
    ...
    echo "<span class=\"remove-entry\">X</span></a></div>\n</div>\n";
}
?>
...
if($website) {
    ...
    if(!$result)
        exit("ERROR: Could not get ids and names of queries from database.");
