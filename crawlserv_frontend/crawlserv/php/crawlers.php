...
if(isset($website)) {
    ...
    echo "<div class=\"entry-label\">Crawler:</div><div class=\"entry-x-input\">\n";
    echo "<select id=\"config-select\" class=\"entry-x-input\" data-m=\"$m\" data-mode=\"$mode\">\n";
    
    $result = $dbConnection->query("SELECT id, name FROM crawlserv_configs WHERE website=$website AND module='crawler'");
...
if(isset($website)) {
    ...
    echo "<div class=\"opt-label\">Name:</div>\n<div class=\"opt-value\" data-tippy=\"Name of the crawling configuration.\""
    ...
    if($config) {
        echo "<a href=\"#\" class=\"action-link config-update\" data-m=\"$m\">";
        echo "Change crawler</a>\n";
    }
    else echo "<a href=\"#\" class=\"action-link config-add\" data-module=\"crawler\" data-m=\"$m\">Add crawler</a>\n";
    echo "</div>\n";
    echo "</div>\n";
    echo "</div>\n";
}
