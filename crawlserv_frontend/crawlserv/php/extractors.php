 ...
 * extractors.php
 *
 * Manage configurations for extractor threads.
 *
 */
...
if(isset($website)) {
    echo rowConfigSelect("Extractor", true);
}
...
if(isset($website)) {
    ...
    echo "<div class=\"opt-value\" data-tippy=\"Name of the extracting configuration.\""
    ...
    if($config) {
        ...
        echo "Change extractor</a>\n";
    }
    else {
        echo "<a href=\"#\" class=\"action-link config-add\" data-module=\"extractor\" data-m=\"$m\" data-mode=\"$mode\">";
        echo "Add extractor</a>\n";
    }
